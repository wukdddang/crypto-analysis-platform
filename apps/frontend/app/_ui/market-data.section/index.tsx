        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              ...
              <div>
                <div className="text-sm text-gray-600 mb-1">Change (1H)</div>
                <div className={`text-lg font-semibold ${
                  marketData.change1h >= 0 ? 'text-green-600' : 'text-red-600'
                }`}>
                  {marketData.change1h > 0 ? '+' : ''}{marketData.change1h}%
                </div>
              </div>
              
              <div>
                <div className="text-sm text-gray-600 mb-1">Change (1 day)</div>
                <div className={`text-lg font-semibold ${
                  marketData.change1d >= 0 ? 'text-green-600' : 'text-red-600'
                }`}>
                  {marketData.change1d > 0 ? '+' : ''}{marketData.change1d}%
                </div>
              </div>
              
              <div>
                <div className="text-sm text-gray-600 mb-1">Change (1 week)</div>
                <div className={`text-lg font-semibold ${
                  marketData.change1w >= 0 ? 'text-green-600' : 'text-red-600'
                }`}>
                  {marketData.change1w > 0 ? '+' : ''}{marketData.change1w}%
                </div>
              </div>
            </div>
          </div>
